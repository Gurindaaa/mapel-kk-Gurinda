...
INSERT INTO tb_area_parkir (id_area, nama_area, kapasitas, terisi)
VALUES
(2, 'Pasar Induk', 50, 1),
...
-- INDEX & RELASI
ALTER TABLE tb_area_parkir ADD PRIMARY KEY (id_area);
ALTER TABLE tb_kendaraan ADD PRIMARY KEY (id_kendaraan), ADD KEY id_user (id_user);
ALTER TABLE tb_log_aktivitas ADD PRIMARY KEY (id_log), ADD KEY id_user (id_user);
ALTER TABLE tb_tarif ADD PRIMARY KEY (id_tarif);
ALTER TABLE tb_transaksi ADD PRIMARY KEY (id_parkir),
...
-- AUTO INCREMENT
ALTER TABLE tb_area_parkir MODIFY id_area int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE tb_kendaraan MODIFY id_kendaraan int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
ALTER TABLE tb_log_aktivitas MODIFY id_log int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=79;
ALTER TABLE tb_tarif MODIFY id_tarif int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
ALTER TABLE tb_transaksi MODIFY id_parkir int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
ALTER TABLE tb_user MODIFY id_user int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

-- FOREIGN KEY
ALTER TABLE tb_kendaraan ADD CONSTRAINT tb_kendaraan_ibfk_1 FOREIGN KEY (id_user) REFERENCES tb_user (id_user);
ALTER TABLE tb_log_aktivitas ADD CONSTRAINT tb_log_aktivitas_ibfk_1 FOREIGN KEY (id_user) REFERENCES tb_user (id_user);
ALTER TABLE tb_transaksi ADD CONSTRAINT tb_transaksi_ibfk_1 FOREIGN KEY (id_kendaraan) REFERENCES tb_kendaraan (id_kendaraan),
